...
images : dossier contenant les images utilisées sur le site (ex : campNou.jpg).

liste-transfert.html et apropos.html : pages secondaires pour afficher les transferts et des informations supplémentaires.

FontAwesome : utilisé pour afficher des icônes dans le site 
...
FontAwesome : pour ajouter des icônes au site.

Images : pour illustrer le contenu et rendre le site plus attractif.
